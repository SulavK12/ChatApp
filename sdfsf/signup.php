<?php
	...
	else if (isset($_POST['submit']))
	{
        ...
        if(strlen($password)  < 8){
            ...
            {
                $sql=mysqli_query($conn, "select user_name from users WHERE user_name='$user_name'") or die (mysqli_error($conn));
		        ...
		        {
			    mysqli_query($conn, "INSERT INTO users (user_name,password,country,gender)
			    VALUES ('$user_name','$pass_enc3','$country','$gender')") or die (mysqli_error($conn));
...
<div id="welcome-css">
    ...
    <div id="box">
        <form action="signup.php" method="post" enctype="multipart/form-data">
            ...
            <input type="password" name="password2" placeholder="Re-enter password" required><br><br>
